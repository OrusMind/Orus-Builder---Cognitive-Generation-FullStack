/**
 * ============================================================================
 * ORUS BUILDER - BLUEPRINT UPLOADER COMPONENT ⭐
 * ============================================================================
 * 
 * DEVELOPER: Tulio (ORUS Creator)
 * CREATED: 2025-10-10T08:57:00-03:00
 * LAST_MODIFIED: 2025-10-10T08:57:00-03:00
 * COMPONENT_HASH: orus.frontend.component.blueprintuploader.20251010.BLU6L7M8
 * 
 * PURPOSE:
    ...
    for (const file of files) {
      ...
      try {
        ...
        if (isOrus) {
          ...
          toast.info(`Document uploaded (${confidence.toFixed(0)}% ORUS match)`);
        }
      } catch (error) {
