...
/**
 * Remove TypeScript type annotations e dependências externas para compatibilidade com Babel Standalone
...
function removeTypeScriptSyntax(code: string): string {
  ...
  // === DECLARATIONS ===
  // Remover interface/type declarations completas
  ...
  // === DEBUG ===
  console.log('🔍 CÓDIGO LIMPO - Primeiros 600 chars:');
