...
function removeTypeScriptSyntax(code: string): string {
  ...
  // Remover imports de bibliotecas externas e substituir por polyfills
  ...
  // Remover qualquer outro import de biblioteca externa (exceto react e imports relativos)
  ...
  // Remover return type annotations
  cleaned = cleaned.replace(/\)\s*:\s*[\w\[\]<>|&\s]+\s*=>/g, ') =>');
  
  // Remover interface/type declarations
