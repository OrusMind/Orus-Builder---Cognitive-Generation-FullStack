...
// ═══════════════════════════════════════════════════════════════
// ✅ PASSO 0.5: COMBINAR MÚLTIPLOS ARQUIVOS  ← ADICIONAR AQUI!
// ═══════════════════════════════════════════════════════════════
if (cleaned.includes('// ') && (cleaned.match(/\/\/ \w+\.tsx/g) || []).length > 1) {
  ...
  console.log('✅ Step 0.5: Combined multiple files into single file');
} else {
  console.log('✅ Step 0.5: Single file detected, no merge needed');
}
