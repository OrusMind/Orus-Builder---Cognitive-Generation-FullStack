...
function generatePreviewHTMLSafe(code: string, filename: string): string {
  ...
  // ESCAPAR CORRETAMENTE para HTML attribute (srcdoc)
  ...
  <script type="text/babel" data-presets="react,typescript">
    ...
    const App = () => (
      <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap', justifyContent: 'center' }}>
        <${componentName} image="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400" title="Headphone Premium" price={299.90} onAddToCart={() => alert('Adicionado!')} />
        <${componentName} image="https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400" title="Relógio Elegante" price={549.90} />
        <${componentName} image="https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=400" title="Óculos de Sol" price={199.90} />
      </div>
    );
