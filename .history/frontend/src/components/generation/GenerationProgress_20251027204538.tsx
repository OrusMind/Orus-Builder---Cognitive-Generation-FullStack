 ...
 analyzing: {
  icon: () => (
    <img 
      ...
      alt="Trinity AI" 
      className="w-6 h-6 animate-spin"  // ← Girar
      // OU
      className="w-6 h-6 animate-pulse"  // ← Pulsar
      // OU
      className="w-6 h-6 animate-bounce"  // ← Pular
    />
  ),
      ...
      {trinityStatus && (
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4">
            <TrinityStatusIndicator name="Alma" status={trinityStatus.alma} />
            <TrinityStatusIndicator name="Cerebro" status={trinityStatus.cerebro} />
            <TrinityStatusIndicator name="Voz" status={trinityStatus.voz} />
          </div>
        </motion.div>
      )}
    </div>
