...
function cleanComponentCode(code: string): string {
  ...
  // ✅ REMOVER markdown blocks SEM ARRAY PROBLEMÁTICO
  cleanedCode = cleanedCode.split('```typescript').join('');
  cleanedCode = cleanedCode.split('```
  cleanedCode = cleanedCode.split('```javascript').join('');
  cleanedCode = cleanedCode.split('```
  cleanedCode = cleanedCode.split('```ts').join('');
  cleanedCode = cleanedCode.split('```
