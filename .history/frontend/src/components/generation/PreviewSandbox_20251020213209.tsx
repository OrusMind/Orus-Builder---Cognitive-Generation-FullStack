 ...
 * Remove markdown, TypeScript syntax, e organiza arquivos
 */
function processMultiFileCode(code: string): { 
  ...
  // ✅ NÃO ADICIONAR import React aqui (será injetado via CDN + destructuring no HTML)
  // O destructuring dos hooks acontece no generatePreviewHTMLSafe()
  ...
  return { 
    isMultiFile: true, 
    processedCode: removeTypeScriptSyntax(allContent),  // ✅ Remover TypeScript DEPOIS de juntar
    componentName 
  };
}
