...
// ═══════════════════════════════════════════════════════════════
// ✅ PASSO 2.7: REMOVER 'export' DE CONST/FUNCTION/CLASS (MANTER DECLARAÇÕES)
// ═══════════════════════════════════════════════════════════════
// Transforma:
//   export const ProductCard = ... → const ProductCard = ...
//   export function useCart() ... → function useCart() ...
//   export class CartService ... → class CartService ...

cleaned = cleaned.replace(/export\s+(const|function|class)\s+/g, '$1 ');
console.log('✅ Step 2.7: Removed "export" keyword from named exports (preserving declarations)');
