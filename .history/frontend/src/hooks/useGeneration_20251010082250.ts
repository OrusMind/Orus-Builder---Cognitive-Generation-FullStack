 ...
 * LAST_MODIFIED: 2025-10-10T08:16:00-03:00
  ...
  const startGeneration = useCallback(async (request: GenerationRequest) => {
    try {
      ...
      setState((prev) => ({
        ...
        projectId: response.projectId || response.jobId, // ← FALLBACK
