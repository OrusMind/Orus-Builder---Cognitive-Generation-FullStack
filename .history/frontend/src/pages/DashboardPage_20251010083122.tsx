...
export const DashboardPage: React.FC = () => {
     ...
     const mockProjects = [
  {
    ...
    framework: Framework.REACT,  // ← USAR ENUM
    language: ProgrammingLanguage.TYPESCRIPT,  // ← USAR ENUM
    createdAt: new Date('2025-10-08'),
    updatedAt: new Date('2025-10-09'),
    status: ProjectStatus.ACTIVE,  // ← USAR ENUM
  ...
  },
  {
    ...
    framework: Framework.NEXTJS,  // ← USAR ENUM
    language: ProgrammingLanguage.TYPESCRIPT,  // ← USAR ENUM
