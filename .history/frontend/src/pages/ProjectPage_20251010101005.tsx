      ...
      <div className="h-screen flex flex-col bg-background">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-primary/20 bg-background-surface">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              onClick={() => toast.success('Run project (coming soon)')} // ✅ FIXED: info -> success
              variant="secondary"
              size="sm"
            ...
            <Button
              onClick={() => toast.success('Download project (coming soon)')} // ✅ FIXED: info -> success
              variant="ghost"
              size="sm"
            ...
            <button
              onClick={() => toast.success('Project settings (coming soon)')} // ✅ FIXED: info -> success
        ...
        <div className="flex-1 overflow-hidden">
          {/* ✅ FIXED: Simplified Split usage */}
          <Split
            className="flex h-full"
            sizes={showSidebar ? [70, 30] : [100, 0]}
            minSize={showSidebar ? 300 : 0}
            gutterSize={showSidebar ? 8 : 0}
          >
              ...
              >
                ...
                <div className="p-6 rounded-lg bg-background-surface border border-primary/20">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <Button
                      onClick={() => toast.success('Coming soon')} // ✅ FIXED: info -> success
                      variant="secondary"
                      fullWidth
                      leftIcon={<Play className="w-4 h-4" />}
                    >
            ...
            {showSidebar && (
              <div className="flex flex-col bg-background-surface border-l border-primary/20">
                {/* Tabs */}
