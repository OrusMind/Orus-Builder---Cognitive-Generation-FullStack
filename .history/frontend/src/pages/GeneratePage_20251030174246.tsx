...
export const GeneratePage: React.FC = () => {
  ...
  const handleGenerate = async (prompt: string, options: PromptOptions) => {
    ...
    try {
      ...
      // ✅ FIX #19: Improved stage messages with i18n support
      ...
      const stages = theme === 'dark' || true ? stagesPortuguese : stagesEnglish;
      ...
      addMessage(
        'trinity',
        `🎉 Código REAL gerado! ${formattedFiles.length} arquivos criados com sucesso!`
      );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex flex-col">
      {/* ✅ FIX #20: Header with Theme & Logo Improvements */}
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              {/* ✅ FIX #20.1: Enhanced Logo - Larger & Better Presentation */}
              <div className="relative">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-br from-blue-400/20 to-purple-400/20 rounded-full blur-lg"></div>
              </div>
            ...
            <div className="flex items-center gap-3">
              {/* ✅ FIX #20.2: Functional Theme Toggle */}
              <button
            ...
            {isGenerating && (
              ...
              >
                <div className="text-center space-y-6">
                  {/* ✅ FIX #21: Improved Loading Animation */}
                  ...
                  <div>
                    ...
                    <p className="text-xl text-gray-700 dark:text-gray-300 min-h-[2rem]">
                      {currentStage}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  {/* ✅ FIX #21.1: Enhanced Progress Bar */}
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className={`text-xs ${
                          ...
                          {files.length} arquivos • {files.reduce((acc, f) => acc + f.lines, 0)} linhas
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      >
                        ...
                        <span className="text-sm font-medium hidden sm:inline">Deploy</span>
                        <span className="text-xs">(Coming soon)</span>
                      </button>
                    </div>
                  </div>
                ...
                <div className={`glass-card p-6 bg-gradient-to-r rounded-2xl ${
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    >
                      ...
                      <h4 className="font-semibold text-sm mb-1">Baixar Código</h4>
                      <p className={`text-xs ${
                        theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                      }`}>
                    ...
                    >
                      ...
                      <h4 className="font-semibold text-sm mb-1">Salvar Projeto</h4>
                      <p className={`text-xs ${
                        theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                      }`}>
                    ...
                    >
                      ...
                      <h4 className="font-semibold text-sm mb-1">Ver Dashboard</h4>
                      <p className={`text-xs ${
                        theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                      }`}>
                        Gerenciar projetos
                    ...
                    >
                      ...
                      <h4 className="font-semibold text-sm mb-1">Deploy Rápido</h4>
                      <p className={`text-xs ${
                        theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                      }`}>
                        Publicar online
