...
export const DashboardPage: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      // Load projects (mock for now - replace with actual API)
     const mockProjects = [
  {
    id: '1',
    ...
    createdAt: new Date('2025-10-08').toISOString(),  // ← CONVERTER PARA STRING
    updatedAt: new Date('2025-10-09').toISOString(),  // ← CONVERTER PARA STRING
  ...
  },
  {
    ...
    language: ProgrammingLanguage.TYPESCRIPT,
    createdAt: new Date('2025-10-07').toISOString(),  // ← CONVERTER PARA STRING
    updatedAt: new Date('2025-10-09').toISOString(),  // ← CONVERTER PARA STRING
    status: ProjectStatus.ACTIVE,
    owner: 'current-user-id',
    files: [],
      ...
      // Load recent activity (mock)
      setRecentActivity([
        {
          id: '1',
          type: 'generation',
          message: 'Generated E-commerce Dashboard',
          timestamp: new Date('2025-10-09T20:30:00'),
        },
        {
          id: '2',
          type: 'update',
          message: 'Updated Blog Platform',
          timestamp: new Date('2025-10-09T19:15:00'),
        },
      ]);
    } catch (error) {
