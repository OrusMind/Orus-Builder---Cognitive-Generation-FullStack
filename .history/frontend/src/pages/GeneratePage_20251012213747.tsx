...
/**
 * Build preview HTML - VERSÃO SEM BABEL (Detecta tipo do componente)
 */
const buildPreviewHTML = (): string => {
  try {
    ...
    const isButton = code.includes('button') && !isForm;
    
    const componentType = isForm ? 'Formulário' : isButton ? 'Botão' : 'Componente';
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    #root {
      ...
      ${isForm ? 'max-width: 500px; width: 100%;' : 'text-align: center;'}
    }
    ...
    .component-subtitle {
      font-size: 14px;
      color: #6b7280;
      margin-bottom: ${isForm ? '40px' : '30px'};
      text-align: center;
    }
      ...
      function ${componentName}() {
        ...
        return React.createElement('div', null,
          ...
          React.createElement('div', {
            className: 'success-message' + (submitted ? ' show' : '')
