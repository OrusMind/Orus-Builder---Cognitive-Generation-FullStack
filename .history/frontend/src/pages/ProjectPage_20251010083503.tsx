...
const FRAMEWORK_CONFIG = {
  react: { color: 'blue', bg: 'blue-50', label: 'React' },
  vue: { color: 'green', bg: 'green-50', label: 'Vue' },
  angular: { color: 'red', bg: 'red-50', label: 'Angular' },
  nextjs: { color: 'black', bg: 'gray-50', label: 'Next.js' },
  nuxtjs: { color: 'green', bg: 'green-50', label: 'Nuxt.js' },  // ← ADICIONAR
  svelte: { color: 'orange', bg: 'orange-50', label: 'Svelte' },  // ← ADICIONAR
};

const LANGUAGE_CONFIG = {
  typescript: { color: 'blue', bg: 'blue-50', label: 'TypeScript' },
  javascript: { color: 'yellow', bg: 'yellow-50', label: 'JavaScript' },
  python: { color: 'blue', bg: 'blue-50', label: 'Python' },  // ← ADICIONAR
};

const STATUS_CONFIG = {
  active: { color: 'green', bg: 'green-50', label: 'Active' },
  archived: { color: 'gray', bg: 'gray-50', label: 'Archived' },
  draft: { color: 'yellow', bg: 'yellow-50', label: 'Draft' },
  generating: { color: 'blue', bg: 'blue-50', label: 'Generating' },  // ← ADICIONAR
  error: { color: 'red', bg: 'red-50', label: 'Error' },  // ← ADICIONAR
};
