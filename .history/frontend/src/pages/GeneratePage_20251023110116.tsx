...
const [generationId, setGenerationId] = useState<string>('');
  ...
  // ✅ SALVAR O generationId SE EXISTIR
  ...
  // ✅ SALVAR generationId DO RESULTADO TAMBÉM (caso não tenha vindo antes)
  if (result.generationId && !data.generationId) {
...
const handleDownload = () => {
  ...
  // ✅ SIMPLES! APENAS REDIRECIONAR PARA A ROTA DE DOWNLOAD
  window.location.href = `http://localhost:5000/api/v1/generation/download/${generationId}`;
