/**
 * ============================================================================
 * ORUS BUILDER - ROOT APP COMPONENT (UPDATED)
 * ============================================================================
 * 
 * DEVELOPER: Tulio (ORUS Creator)
 * CREATED: 2025-10-09T20:38:00-03:00
 * LAST_MODIFIED: 2025-10-10T09:06:00-03:00
 * COMPONENT_HASH: orus.frontend.app.root.20251010.APP8I9J0
 * 
 * PURPOSE:
...
// Components for testing (if pages don't exist yet)
import { PromptInput } from '@components/generation/PromptInput';
import { GenerationProgress } from '@components/generation/GenerationProgress';
import { CodePreview } from '@components/generation/CodePreview';
import { ValidationResults } from '@components/generation/ValidationResults';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <button
          onClick={toggleTheme}
          className="fixed top-4 right-4 z-50 p-3 bg-background-surface border border-primary/20 rounded-lg hover:border-primary/50 transition-colors shadow-elevated"
        ...
        {/* Routes */}
        <Routes>
          {/* Landing - Shows component showcase */}
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold text-foreground mb-4">Prompt Input Test</h1>
        <PromptInput
...
const TestGenerationProgress: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold text-foreground mb-4">Generation Progress Test</h1>
        <GenerationProgress
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold text-foreground mb-4">Code Preview Test</h1>
...
const TestBlueprint: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold text-foreground mb-4">Blueprint Test</h1>
        ...
        {!showParser ? (
          ...
          <>
            <button
              ...
              className="mb-4 px-4 py-2 bg-primary text-background rounded-lg hover:bg-primary/80 transition-colors"
            >
              Back to Upload
            </button>
            <BlueprintParser
 ...
 * EXPORT MANIFEST
 * ============================================================================
 * PRIMARY_EXPORT: App (Root component with test routes)
 * NAMED_EXPORTS: None
