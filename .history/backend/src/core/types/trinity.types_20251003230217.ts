 ...
 */
export interface TrinityCache Entry {
  key: string;
  component: TrinityComponent;
  operation: TrinityOperation;
 ...
 */
export interface TrinityCache Config {
  enabled: boolean;
  ttl: number; // seconds
  maxSize: number; // MB
 ...
 */
export interface AlmaResponse<T = unknown> extends TrinityResponse<T> {
  component: TrinityComponent.ALMA;
  data?: {
    results: T[];
    relevance: number[];
...
/**
 * CEREBRO Request - Requisição para CEREBRO (Logic)
 */
export interface CerebroRequest extends TrinityRequest {
 ...
 */
export interface CerebroResponse<T = unknown> extends TrinityResponse<T> {
  component: TrinityComponent.CEREBRO;
  data?: {
    solution: T;
    reasoning: string;
...
/**
 * VOZ Request - Requisição para VOZ (Communication)
 */
export interface VozRequest extends TrinityRequest {
 ...
 */
export interface VozResponse<T = unknown> extends TrinityResponse<T> {
  component: TrinityComponent.VOZ;
  data?: {
