/**
 * ═══════════════════════════════════════════════════════════════════════════
 * 🧬 ORUS BUILDER - EXPRESS SERVER (WITH ENGINES) - PATHS CORRETOS
 * ═══════════════════════════════════════════════════════════════════════════
 */
  ...
  private mountRoutes(): void {
    ...
    this.app.get('/health', async (req, res) => {
      ...
      return res.json({
        ...
        engines: {
          generation: cognitiveGenerationEngine.isInitialized(),
          cig: cigEngine.isInitialized(),
          blueprint: blueprintEngine.isInitialized(),
    ...
    this.app.post('/test/blueprint', async (req, res) => {
      try {
        ...
        const result = await blueprintEngine.analyze(description);
