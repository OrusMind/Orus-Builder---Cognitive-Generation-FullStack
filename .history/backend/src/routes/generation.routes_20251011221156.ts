...
router.post('/test', async (req, res) => {
  try {
    ...
    // Generate with manual specification (bypasses Prompt Engine)
        ...
        components: [
          {
            name: 'User',
            type: 'component',
            purpose: prompt || 'User class with properties',
            responsibilities: ['Store user data', 'Validate properties'],
            dependencies: [], // ✅ Required field
priority: 1  // ← Number (1=high, 2=medium, 3=low)
        ...
        technologies: {
          backend: [
            {
              name: 'TypeScript', // ✅ Technology object
              version: 'latest',
