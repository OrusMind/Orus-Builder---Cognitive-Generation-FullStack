...
export class ComplianceValidator {
  ...
  pt_BR: 'Conformidade com Regulamento Geral de Proteção de Dados',
  es: 'Cumplimiento del Reglamento General de Protección de Datos'
}
,
      mandatory: true,
    ...
    this.addRequirement({
     ...
     description: {
  en: 'Brazilian data protection law compliance', // ou conforme contexto
  pt_BR: 'Conformidade com Lei Geral de Proteção de Dados',
  es: 'Cumplimiento de la Ley General de Protección de Datos'
},
