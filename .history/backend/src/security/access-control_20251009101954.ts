...
export class AccessControl {
  ...
  private initializeDefaultRoles(): void {
    ...
    this.roles.set(Role.GUEST, {
      ...
      roleId: Role.GUEST,
      name: 'Guest',
      description: { en: 'Guest user with minimal permissions' },
    ...
    this.roles.set(Role.USER, {
      ...
      roleId: Role.USER,
      name: 'User',
      description: { en: 'Standard user with project creation permissions' },
      permissions: [
    ...
    this.roles.set(Role.DEVELOPER, {
      ...
      name: 'Developer',
      description: { en: 'Developer with template and marketplace access' },
      permissions: [
        Permission.PROJECT_CREATE,
        Permission.PROJECT_READ,
        Permission.PROJECT_UPDATE,
    ...
    this.roles.set(Role.ADMIN, {
      ...
      roleId: Role.ADMIN,
      name: 'Admin',
      description: { en: 'Administrator with user management permissions' },
      permissions: [
    ...
    this.roles.set(Role.SUPER_ADMIN, {
      ...
      name: 'Super Admin',
      description: { en: 'Super administrator with full system access' },
  ...
  private initializeDefaultPolicies(): void {
    ...
    this.policies.set('project-ownership', {
      ...
      description: { en: 'Project owners have full control over their projects' },
    ...
    this.policies.set('admin-system-access', {
      ...
      description: { en: 'Admins can access system configuration and monitoring' },
