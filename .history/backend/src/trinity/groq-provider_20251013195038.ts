...
`;
   ...
   */
  private buildCodeGenerationPrompt(language: string): string {
    return `You are an expert TypeScript developer specialized in enterprise-grade code generation.

Your task is to generate clean, type-safe TypeScript code following these principles:
- Zero compilation errors (CIG-2.0 protocol)
