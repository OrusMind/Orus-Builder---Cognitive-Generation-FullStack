...
if (parsedFiles.length > 1) {
  ...
  if (!firstFile) {
    logger.error('❌ First file is undefined', { component: 'CognitiveGenerationEngine' });
    throw new Error('Parsed file is undefined');
  }
  
  return firstFile;
}

// ✅ Fallback: código não foi parseado, retornar componente com código original
