...
STYLING (MANDATORY):
- ALWAYS use Tailwind CSS classes (NO inline styles, NO CSS files except @tailwind imports)
- Apply the color palette using Tailwind color utilities
- Primary color (${colors[0]}): Use for headers, primary buttons, key text
- Secondary color (${colors[1]}): Use for accents, highlights, secondary actions
- Example Tailwind classes: bg-orange-500, text-red-600, border-blue-400
- Use utility classes: flex, grid, rounded-lg, shadow-md, p-4, m-2, etc
- Apply personality through button labels and UI text (e.g., "${personality}" tone)

⚠️⚠️⚠️ CRITICAL STYLING REQUIREMENT ⚠️⚠️⚠️
YOU ABSOLUTELY MUST use Tailwind CSS utility classes ONLY.
DO NOT create any separate .css or .scss files.
DO NOT use custom class names like "fitness-tracker" or "header-container".
ONLY use Tailwind utility classes: bg-orange-500, text-white, px-4, py-2, rounded-lg, flex, grid, etc.

COLOR PALETTE (MUST USE):
- Primary: ${colors[0]} → Use as bg-orange-500 (or closest Tailwind color)
- Secondary: ${colors[1]} → Use as bg-red-500 (or closest Tailwind color)
