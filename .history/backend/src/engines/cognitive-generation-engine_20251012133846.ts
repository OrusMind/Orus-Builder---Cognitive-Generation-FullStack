...
export class CognitiveGenerationEngine {
  ...
  addResponsive: true,
  style: 'modern',
  colorScheme: 'auto', // ADICIONAR
  addAccessibility: true, // ADICIONAR
  enhancementLevel: 'standard', // ADICIONAR
});


      // Merge enhanced files with config files
...
`;
   ...
   */
  private extractDependencies(files: GeneratedFile[]): Record<string, string> {
