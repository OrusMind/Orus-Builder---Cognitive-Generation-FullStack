// ═══════════════════════════════════════════════════════════════════════════
// 🔷 SEÇÃO 1: IMPORTS & TYPES (CORRIGIDO)
// ═══════════════════════════════════════════════════════════════════════════

// Core dependencies
import { logger } from '../utils/logger';
import { TrinityOrchestrator } from '../trinity/trinity-orchestrator';
import { getAIProvider } from '../trinity/ai-provider-factory';
...
import type {
  ...
  OptimizationResult,
  ValidationResult as CIGValidationResult
} from '../core/types/cognitive.types';

import type {
  ProcessingResult
} from '../prompt/prompt-processor';

/**
 * Generation Request (criado aqui pois não existe em types)
 */
...
/**
 * Validation Result (wrapper para CIG)
 */
