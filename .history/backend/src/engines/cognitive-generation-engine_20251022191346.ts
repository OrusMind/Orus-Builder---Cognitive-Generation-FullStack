...
private async generateComponent(
  ...
  // ═══════════════════════════════════════════════════════════════════════
// ✅ CORREÇÃO: SE MULTI-FILE → RETORNAR TODOS OS ARQUIVOS!
// ═══════════════════════════════════════════════════════════════════════
if (parsedFiles.length > 0) {
  ...
  console.log('\n✅ ═══════════════════════════════════════════════════════════');
  console.log('✅ RETURNING MULTIPLE FILES TO ORCHESTRATOR:');
  ...
  // ✅ HACK: Como esse método retorna 1 GeneratedComponent,
  // vamos retornar o primeiro MAS com os outros no metadata
  // (Orchestrator precisa pegar de lá)
  const mainFile = parsedFiles[0]!;
  
  // ✅ Salvar TODOS os arquivos no metadata (inclusive o principal)
