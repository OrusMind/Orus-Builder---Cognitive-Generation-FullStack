...
private async generateComponentWithEngines(
  ...
  /**
 * ═══════════════════════════════════════════════════════════════════════════
 * 🔧 BACKEND GENERATION v3.1 (TIPOS CORRIGIDOS)
 * ═══════════════════════════════════════════════════════════════════════════
 */
if (isBackend) {
  try {
    ...
    // ✅ CORREÇÃO: Usar enum correto BackendArchitecture.MVC
    const backendInput: BackendGenerationInput = {
      projectName: request.projectName || 'backend-api',
      architecture: BackendArchitecture.MVC, // ✅ Usar enum, não string
    ...
    // ✅ CORREÇÃO: BackendGenerationResult NÃO tem 'success', sempre retorna resultado
    // Verificar se tem conteúdo ao invés de .success
