...
private detectScopeFromIntent(
  ...
  if (userComplexity) {
    ...
    // ✅ TIPAGEM CORRETA: definir constante com tipo explícito
    ...
    // ✅ CORREÇÃO: Adicionar fallback para evitar undefined
    const result = complexityMap[userComplexity];
    if (result) {
      return result;
    }
    // Se userComplexity inválido, continua para auto-detection
    console.log(`⚠️ [Scope] Invalid userComplexity: ${userComplexity}, falling back to auto-detection`);
  }
