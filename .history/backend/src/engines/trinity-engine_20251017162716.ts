...
class AlmaConnector {
  private aiProvider: IAIProvider | null = null;  // ✅ NULL INICIAL
  
  constructor() {
    // ✅ NÃO INSTANCIA NADA AQUI
  }
...
Return ONLY the JSON, no explanation.`;
      ...
      const response = await this.getProvider().chat([  // ✅ USA getProvider()
...
class CerebroConnector {
  ...
  async makeDecision(/* ... */) {
    // ... usar this.getProvider().chat() ao invés de this.aiProvider.chat()
  }
}
