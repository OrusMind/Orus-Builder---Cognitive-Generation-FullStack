...
// Types já exportados via "export interface" não precisam ser re-exportados aqui
// GenerationRequest → já tem "export interface" na linha ~90
// GenerationResult → já tem "export interface" na linha ~115
// GeneratedComponent → já tem "export interface" na linha ~103
