...
private buildFrontendPrompt(
 ...
 const prompt = `Generate a SINGLE FILE React TypeScript component named ${component.name}.

CRITICAL RULE: Return EXACTLY ONE FILE with ALL code inline.

NO separate files. NO imports from local files. NO axios or external APIs.
ALL interfaces inline. ALL functions inline. ONLY import React.

Use mock data with ${language} names. Use Tailwind CSS. Make it interactive.

Component purpose: ${component.purpose}

Return ONLY the TypeScript code now:`;
