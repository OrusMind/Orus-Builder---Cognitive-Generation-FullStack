...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 * ✅ VERSÃO FINAL CORRIGIDA - SEM MERGE AUTOMÁTICO + LOGS DE DEBUG
 * ═══════════════════════════════════════════════════════════════════════════
 */
private async generateComponent(
  ...
  console.log('🔍 ═══════════════════════════════════════════════════════════');
  console.log(code.substring(0, 800));  // Primeiros 800 caracteres
  ...
  if (parsedFiles.length > 1) {
    ...
    // ✅ CRÍTICO: Salvar arquivos extras no metadata (NÃO FAZER MERGE!)
    mainComponent.metadata = {
      ...mainComponent.metadata,
      additionalFiles: parsedFiles.slice(1)  // Todos exceto o primeiro
    };
