...
/**
 * Extrai interfaces do código (versão ULTRA-MELHORADA)
 * Remove interfaces E comentários JSDoc acima delas
 */
private extractInterfacesFromCode(code: string): string[] {
  const interfaces: string[] = [];
  
  // Regex para capturar:
  // 1. Comentários JSDoc (opcionais)
  // 2. export interface Nome { ... }
