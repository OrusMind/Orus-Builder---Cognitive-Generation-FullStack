...
private detectScopeFromIntent(
  analysis: PromptAnalysisResult,
  originalPrompt: string,
  userComplexity?: 'minimal' | 'standard' | 'feature_rich' | 'enterprise' // ✅ NOVO PARÂMETRO
  ...
  if (userComplexity) {
    ...
    const complexityMap = {
      'minimal': {
        ...
        complexity: 'simple',
        confidence: 1.0, // 100% porque foi escolha manual
  ...
  // Se tem palavra-chave de componente único E NÃO menciona aplicação/API/fullstack
  ...
  // ═══════════════════════════════════════════════════════════════
  // PRIORITY 2: FULLSTACK (HIGHEST PRIORITY!)
  // ═══════════════════════════════════════════════════════════════
