...
**CRITICAL RENDERING RULES - SANDBOX LIMITATIONS:**
- ❌ DO NOT use external chart libraries: Recharts, Chart.js, Victory, D3, etc
- ❌ DO NOT use external UI libraries: Material-UI, Ant Design, Chakra UI, etc
- ❌ DO NOT use axios, fetch to external APIs (use mock data instead)
- ❌ DO NOT use lodash, moment.js, date-fns, or utility libraries
- ✅ ONLY use: React, React hooks (useState, useEffect), vanilla JavaScript
- ✅ Use CSS-in-JS or inline styles with basic CSS
- ✅ Create mock data directly in the component (arrays, objects)
- ✅ For charts/graphs: Use CSS and HTML divs to create simple bar charts or visualizations
- ✅ For dashboards: Use cards, tables, and simple styled divs

**EXAMPLES OF CORRECT IMPLEMENTATIONS:**
Instead of Recharts LineChart, use:
<div style="display: flex; align-items: flex-end; height: 200px;">
  {data.map(point => (
    <div key={point.id} style="height: {point.value}px; width: 20px; backgroundColor: '#8884d8'; margin: '0 2px'"></div>
  ))}
</div>
