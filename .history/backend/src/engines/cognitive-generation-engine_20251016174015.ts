...
private buildFrontendPrompt(
  ...
  const prompt = `🚨🚨🚨 CRITICAL SYSTEM CONSTRAINT - READ THIS FIRST! 🚨🚨🚨

YOU ARE GENERATING CODE FOR A BROWSER SANDBOX THAT **CANNOT** ACCESS EXTERNAL LIBRARIES!

**THESE LIBRARIES WILL CAUSE RUNTIME ERRORS:**
❌ Recharts, Chart.js, Victory, D3 (any chart library) → FORBIDDEN!
❌ Axios, fetch to real APIs → FORBIDDEN!
❌ Material-UI (@mui/material), Ant Design, Chakra UI → FORBIDDEN!
❌ Lodash, Moment.js, date-fns → FORBIDDEN!
❌ React Router, Next.js, Framer Motion → FORBIDDEN!

**YOU MUST ONLY USE:**
✅ React (useState, useEffect, useCallback, useMemo, useRef)
✅ Standard JavaScript (Array, Object, Math, Date, etc)
✅ Tailwind CSS classes (inline only)
✅ Mock data (defined inline in the component)

**IF YOU USE ANY FORBIDDEN LIBRARY, THE CODE WILL NOT RUN IN THE PREVIEW!**
