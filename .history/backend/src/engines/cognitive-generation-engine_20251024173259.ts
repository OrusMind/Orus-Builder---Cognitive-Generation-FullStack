...
try {
  ...
  // ✅ BackendGenerationResult tem controllers, services, routes, etc.
  const backendFiles = [
    ...backendResult.controllers,
    ...backendResult.services,
    ...backendResult.middleware,
  ...
  if (backendFiles.length > 0) {
    ...
    logger.info(`✅ Generated ${backendFiles.length} backend files`);
  }
} catch (backendError) {
