...
class AuthenticationMiddleware {
  ...
  algorithms: [this.JWT_ALGORITHM as jwt.Algorithm]
  ...
  algorithm: this.JWT_ALGORITHM as jwt.Algorithm,
  expiresIn
});
  }
  ...
  { userId, type: 'refresh' },
  this.JWT_SECRET,
  { algorithm: this.JWT_ALGORITHM as jwt.Algorithm, expiresIn: '30d' }
);
  }
