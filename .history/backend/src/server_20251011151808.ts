...
this.app.get('/test/mongodb', async (req, res) => {
  try {
   ...
   const uri = 'mongodb://kaycnascimento8:L4mamLTvSY5TIfjj@cluster0-shard-00-00.ovu5.mongodb.net:27017,cluster0-shard-00-01.ovu5.mongodb.net:27017,cluster0-shard-00-02.ovu5.mongodb.net:27017/orus-builder?ssl=true&replicaSet=atlas-abc123-shard-0&authSource=admin&retryWrites=true&w=majority';
