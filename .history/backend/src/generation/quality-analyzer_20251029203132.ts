...
const dnaHeaderAnalysis = this.analyzeDNAHeader(code); 
...
private analyzeDNAHeader(code: string): {
  ...
  reliability: 0.15,
  security: 0.20,        // Aumentado (Zod + JWT críticos)
  performance: 0.05,
  testability: 0.10,
  documentation: 0.10,
  typeSafety: 0.10,      // Aumentado (remover 'any')
  dnaHeader: 0.05        // NOVO - ORUS compliance
};
