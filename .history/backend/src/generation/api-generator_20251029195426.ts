 ...
 * GET /api/${resourceName}/filter?status=completed&priority=high
 */
router.get(
  '/${resourceName}/filter',
  authMiddleware,
  validate(${resourceName}Schemas.filter),
  ${controllerInstance}.findWithFilters.bind(${controllerInstance})
);

/**
 * Search by text
 * GET /api/${resourceName}/search?q=keyword
 */
router.get(
  '/${resourceName}/search',
  authMiddleware,
  validate(${resourceName}Schemas.search),
  ${controllerInstance}.search.bind(${controllerInstance})
);
...
router.get(
  '/${resourceName}/stats',
  authMiddleware,
  ${controllerInstance}.getStats.bind(${controllerInstance})
);
