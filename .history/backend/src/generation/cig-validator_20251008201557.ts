...
export class CIGValidator {
  ...
  public async validate(input: ValidationInput): Promise<ExtendedValidationResult> {
    ...
    try {
      ...
      const suggestions = this.generateSuggestions(issues, codeMetrics, componentName);

      // Stage 7: CIG Protocol validation
      // ✅ FIXED: Using correct validate() method with proper structure
      ...
      // ✅ FIXED: Construct proper ExtendedValidationResult
