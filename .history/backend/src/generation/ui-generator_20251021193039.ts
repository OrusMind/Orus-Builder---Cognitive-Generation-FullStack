...
export interface UIGenerationResult {
  files: GeneratedUIFile[];   // ✅ Adicionar
  styles: string;
  tests?: string;
  storybook?: string;
...
export interface GeneratedUIFile {
  ...
  path: string;
  content: string;
  type: 'component' | 'styles' | 'types' | 'utils' | 'hooks';
}
...
export class UIGenerator {
  ...
  try {
    ...
    // ═══════════════════════════════════════════════════════════════
    // ✅ NOVO: Criar array de arquivos ao invés de string única
    // ═══════════════════════════════════════════════════════════════
    ...
    // ✅ Adicionar arquivo de estilos se necessário
    ...
    // ✅ Adicionar arquivo de types se houver props
    ...
    const result: UIGenerationResult = {
      files,           // ✅ Agora retorna array!
      component,       // ✅ Manter para compatibilidade
      styles,
      tests,
      storybook,
      documentation,
