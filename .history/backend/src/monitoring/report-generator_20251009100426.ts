  ...
  private async generateErrorReport(period: ReportPeriod): Promise<ReportData> {
    ...
    const summary: ReportSummary = {
      ...
      metrics: {
        ...
        'Critical Errors': stats.byLevel.critical || 0
      },
      insights: [
        ...
        `${stats.byLevel.critical || 0} critical errors require immediate attention`
      ]
    };
    ...
    const sections: ReportSection[] = [
      {
        ...
        content: `Critical: ${stats.byLevel.critical} | Error: ${stats.byLevel.error} | Warning: ${stats.byLevel.warning}`,
        data: stats.byLevel,
        level: 'h2'
      },
      {
