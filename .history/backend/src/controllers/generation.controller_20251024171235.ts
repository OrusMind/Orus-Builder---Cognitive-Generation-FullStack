...
/**
 * ═════════════════════════════════════════════════════════════════════════
 * HELPER: Normalize File Paths v3.0
 * ═════════════════════════════════════════════════════════════════════════
 * ✅ Remove "frontend/" prefix para match padrão React/Next.js
 * ✅ Mantém apenas: src/components/, src/types/, etc.
 */
private normalizeFilePaths(files: any[]): any[] {
  logger.debug('Normalizing file paths v3.0');
  ...
  return files.map((file, index) => {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // STEP 2: Fix Groq AI paths (src/frontend/ → src/)
    // ═══════════════════════════════════════════════════════════════════════
    if (path.startsWith('src/frontend/')) {
      path = path.replace('src/frontend/', 'src/');
      console.log('[normalizeFilePaths] Fixed Groq path:', { from: originalPath, to: path });
    }

    // ═══════════════════════════════════════════════════════════════════════
    // STEP 3: Remove "frontend/src/" prefix → "src/"
    // ═══════════════════════════════════════════════════════════════════════
    if (path.startsWith('frontend/src/')) {
      path = path.replace('frontend/src/', 'src/');
      console.log('[normalizeFilePaths] Removed frontend prefix:', { from: originalPath, to: path });
    }

    // ═══════════════════════════════════════════════════════════════════════
    // STEP 4: Remove "frontend/" prefix → direto (root)
    // ═══════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // STEP 5: Backend paths (backend/src/ → server/src/ ou manter)
    // ═══════════════════════════════════════════════════════════════════════
    // Opcional: Se quiser mudar backend/ para server/
    // if (path.startsWith('backend/')) {
    //   path = path.replace('backend/', 'server/');
    // }

    // ═══════════════════════════════════════════════════════════════════════
    // STEP 6: Remove duplicate src/src/
    // ═══════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // STEP 7: Ensure paths start with src/ (se for frontend)
    // ═══════════════════════════════════════════════════════════════════════
    ...
    if (isFrontendFile && !path.startsWith('src/') && !path.startsWith('backend/')) {
      path = `src/${path}`;
      console.log('[normalizeFilePaths] Added src/ prefix:', path);
    }
...
/**
 * ═════════════════════════════════════════════════════════════════════════
 * HELPER: Deduplicate Files (Remove duplicates, keep best version)
 * ═════════════════════════════════════════════════════════════════════════
 */
private deduplicateFiles(files: any[]): any[] {
  ...
  console.log(`  Removed: ${files.length - deduplicated.length} duplicates`);
  console.log('═══════════════════════════════════════════════════════');
...
const result = await cognitiveGenerationEngine.generate(generationRequest); // ✅ SEM CAST
