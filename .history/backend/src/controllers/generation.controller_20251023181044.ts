...
// MODIFICAR MÉTODO generateFromPrompt LINHA ~250-260
public async generateFromPrompt(...) {
  // ... código existente até extração de files ...
  ...
  // ✅ ADICIONAR NORMALIZAÇÃO AQUI:
  console.log('===============================================');
  console.log('[CONTROLLER] 🔧 Normalizing file paths...');
  console.log('===============================================');
  
  generatedFiles = this.normalizeFilePaths(generatedFiles);
  
  console.log('===============================================');
  console.log('[CONTROLLER] ✅ Paths normalized!');
