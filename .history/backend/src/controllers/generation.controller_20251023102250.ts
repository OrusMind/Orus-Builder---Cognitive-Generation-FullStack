...
public async generateFromPrompt(
  ...
  try {
    ...
    // ✅ PREPARAR RESPONSE
    // ═══════════════════════════════════════════════════════════════════════
    const convertedFiles: GeneratedFile[] = allFiles.map((file: any) => ({
  path: file.path,
  content: file.code,  // ← Converter "code" para "content"
...
const response: GenerationResultResponse = {
  generationId,
  success: result.success,
  files: convertedFiles,  // ← Agora com a estrutura correta!
  metrics: {
