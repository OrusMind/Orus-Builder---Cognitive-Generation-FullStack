...
export class DashboardController {
  ...
  async getProjects(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.info('Projects listed', { userId, total });
    } catch (error: any) {
  ...
  async getProject(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.info('Project retrieved', { projectId: id, userId });
    } catch (error: any) {
  ...
  async createProject(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.info('Project created', { projectId: project.projectId, userId, name });
    } catch (error: any) {
  ...
  async getStats(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.info('Stats retrieved', { userId, totalProjects });
    } catch (error: any) {
