...
class Server {
  ...
  constructor() {
    ...
    // ✅ IGNORE ERRO 1: TypeScript não reconhece a nova estrutura de tipos
    // @ts-ignore - Socket.IO v4+ tem estrutura diferente, mas funciona em runtime
  ...
  private configureWebSocket(): void {
    // ✅ IGNORE ERROS 2 e 3: Tipagem do socket é inferida corretamente em runtime
    // @ts-ignore - TypeScript não reconhece o método 'on' mas funciona
