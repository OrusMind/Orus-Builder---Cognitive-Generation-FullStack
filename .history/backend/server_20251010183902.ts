...
import { Server as SocketIOServer, Socket } from 'socket.io'; // ✅ Adicionar Socket
...
class Server {
  ...
  constructor() {
    ...
    // ✅ CORREÇÃO 1: Socket.IO com tipagem correta
  ...
  async initialize(): Promise<void> {
    logger.info('🚀 Initializing ORUS Builder Server...', {
      component: 'Server',
      // ✅ CORREÇÃO 2: Remover 'environment' de LogContext
    });
  ...
  private async initializeEngines(): Promise<void> {
    ...
    try {
      ...
      logger.info('✅ ALL 15 ENGINES OPERATIONAL!', {
        component: 'Server',
        // ✅ CORREÇÃO 4: Remover 'message' de LogContext
      });
  ...
  private configureWebSocket(): void {
    // ✅ CORREÇÃO 5: Adicionar tipo Socket
    this.io.on('connection', (socket: Socket) => {
      logger.info('WebSocket client connected', {
        component: 'WebSocket',
        // ✅ CORREÇÃO 6: Remover 'socketId' de LogContext
      });
      ...
      socket.on('join-session', (sessionId: string) => {
        ...
        logger.debug('Client joined collaboration session', {
          component: 'WebSocket',
          // ✅ CORREÇÃO 7: Remover 'sessionId' de LogContext
        });
      });
      ...
      socket.on('disconnect', () => {
        logger.debug('WebSocket client disconnected', {
          component: 'WebSocket',
          // ✅ CORREÇÃO 8: Remover 'socketId' de LogContext
        });
      });
    });
